...
public class Facebook {
	...
	public JSONObject getProfileJSON()
	{
		...
		JSONObject me;
		try {
			me = new JSONObject(request("me"));
			Log.i("Profile", me.toString());
			Log.i("First Name", me.getString("first_name"));
			Log.i("Last Name", me.getString("last_name"));
			Log.i("Gender", me.getString("gender"));
			Log.i("UserName", me.getString("username"));
	...
	public void authorize(final Context context, String applicationId,
			...
			public void onComplete(Bundle values) {
				...
				if (isSessionValid()) {
					...
					if (isImage) {
						Toast.makeText(
								context,
								"Facebook Login Success! access_token="
										+ getAccessToken() + " expires="
										+ getAccessExpires(), Toast.LENGTH_LONG);
								//.show();
					}
	 ...
	 *            has completed.
	 */
	public void setBooleanVariable(boolean isCheck) {
		isImage = isCheck;
	}
	 ...
	 * Returns null if no session ex ists.
	 * 
